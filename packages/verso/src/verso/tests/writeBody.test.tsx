...
import type { StandardizedPage } from '@/verso/core/handler/Page';

vi.mock('@/verso/core/components/RootContainer', async (importOriginal) => {
  const original = await importOriginal<typeof import('@/verso/core/components/RootContainer')>();
  return {
    ...original,
...
const { writeBody } = await import('@/verso/server/writeBody');
